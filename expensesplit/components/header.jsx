      ...
      <div className="relative">
        <nav className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-4">
            ...
            <Link
  href="/dashboard"
  className="hidden md:inline-flex items-center gap-2 px-4 py-2 border rounded-md text-base font-medium text-pink-500 hover:text-pink-500 hover:border-pink-600 transition"
>
